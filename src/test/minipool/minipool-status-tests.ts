...
export default function runMinipoolStatusTests(web3: Web3, rp: RocketPool) {
  describe("Minipool Status Tests", () => {
    ...
    before(async () => {
      ...
      let stakingStatus1 = await stakingMinipool1.contract.methods
        .getStatus()
        .call()
        .then((value: any) => web3.utils.toBN(value));
      let stakingStatus2 = await stakingMinipool2.contract.methods
        .getStatus()
        .call()
        .then((value: any) => web3.utils.toBN(value));
      let stakingStatus3 = await stakingMinipool3.contract.methods
        .getStatus()
        .call()
        .then((value: any) => web3.utils.toBN(value));
