...
var Contracts = (function () {
  ...
  function Contracts(web3, RocketStorage) {
    ...
    this.rocketStorage = this.web3.eth.net.getId().then(function (networkId) {
      return new _this.web3.eth.Contract(
        RocketStorage.abi,
        RocketStorage.networks[networkId].address
      );
    });
  }
  ...
  _createClass(Contracts, [
    {
      ...
      value: function address(name) {
        ...
        // Load address
        this.addresses[name] = this.rocketStorage.then(function (
          rocketStorage
        ) {
          return rocketStorage.methods
            .getAddress(
              _this2.web3.utils.soliditySha3("contract.address", name)
            )
            .call();
        });
    ...
    },
    {
      ...
      value: function abi(name) {
        ...
        this.abis[name] = this.rocketStorage
          .then(function (rocketStorage) {
            return rocketStorage.methods
              .getString(_this3.web3.utils.soliditySha3("contract.abi", name))
              .call();
          })
          .then(function (abi) {
