...
declare class Auction {
     ...
     */
    private get rocketAuctionManager();
    /**
     ...
     * ```
     */
    getLotExists(lotIndex: number): Promise<boolean>;
    /**
     ...
     * ```
     */
    getLotStartBlock(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotEndBlock(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotStartPrice(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotReservePrice(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotTotalBidAmount(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotTotalRPLAmount(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotAddressBidAmount(lotIndex: number, bidderAddress: string): Promise<number>;
    /**
     ...
     * ```
     */
    getLotPriceByTotalBids(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotCurrentPrice(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotClaimedRPLAmount(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotRemainingRPLAmount(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotIsCleared(lotIndex: number): Promise<boolean>;
    /**
     ...
     * ```
     */
    getLotPriceAtBlock(lotIndex: number, block: number): Promise<number>;
    /**
     ...
     * ```
     */
    getLotRPLRecovered(lotIndex: number): Promise<number>;
    /**
     ...
     * ```
     */
    createLot(options?: SendOptions, onConfirmation?: ConfirmationHandler): Promise<TransactionReceipt>;
    /**
     * Create bid on a lot
     * @param lotIndex A number representing the lot index
     * @param options An optional object of web3.eth.Contract SendOptions
     ...
     * ```
     */
    claimBid(lotIndex: number, options?: SendOptions, onConfirmation?: ConfirmationHandler): Promise<TransactionReceipt>;
    /**
     * Place bid on a lot
     ...
     * ```
     */
    placeBid(lotIndex: number, options?: SendOptions, onConfirmation?: ConfirmationHandler): Promise<TransactionReceipt>;
    /**
     ...
     * ```
     */
    recoverUnclaimedRPL(lotIndex: number, options?: SendOptions, onConfirmation?: ConfirmationHandler): Promise<TransactionReceipt>;
}
