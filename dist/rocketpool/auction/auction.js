  ...
  _createClass(Auction, [
    ...
    },
    {
      ...
      value: function getLotReservePrice(lotIndex) {
        return this.rocketAuctionManager.then(function (rocketAuctionManager) {
          return rocketAuctionManager.methods
    ...
    },
    {
      ...
      value: function getLotPriceAtBlock(lotIndex, block) {
        return this.rocketAuctionManager.then(function (rocketAuctionManager) {
          return rocketAuctionManager.methods
            .getLotPriceAtBlock(lotIndex, block)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function createLot(options, onConfirmation) {
        return this.rocketAuctionManager.then(function (rocketAuctionManager) {
          return (0,
          _transaction.handleConfirmations)(rocketAuctionManager.methods.createLot().send(options), onConfirmation);
        });
      },
    },
    {
      ...
      value: function claimBid(lotIndex, options, onConfirmation) {
        return this.rocketAuctionManager.then(function (rocketAuctionManager) {
          return (0,
          _transaction.handleConfirmations)(rocketAuctionManager.methods.claimBid(lotIndex).send(options), onConfirmation);
        });
      },
    },
    {
      ...
      value: function placeBid(lotIndex, options, onConfirmation) {
        return this.rocketAuctionManager.then(function (rocketAuctionManager) {
          return (0,
          _transaction.handleConfirmations)(rocketAuctionManager.methods.placeBid(lotIndex).send(options), onConfirmation);
        });
      },
    },
    {
      ...
      value: function recoverUnclaimedRPL(lotIndex, options, onConfirmation) {
        return this.rocketAuctionManager.then(function (rocketAuctionManager) {
          return (0,
          _transaction.handleConfirmations)(rocketAuctionManager.methods.recoverUnclaimedRPL(lotIndex).send(options), onConfirmation);
        });
      },
    },
    {
