  ...
  _createClass(NetworkSettings, [
    {
      ...
      value: function getNodeConsensusThreshold() {
        ...
        return this.rocketDAOProtocolSettingsNetwork
          .then(function (rocketDAOProtocolSettingsNetwork) {
            return rocketDAOProtocolSettingsNetwork.methods
    ...
    },
    {
      ...
      value: function getSubmitBalancesEnabled() {
        return this.rocketDAOProtocolSettingsNetwork.then(function (
