  ...
  _createClass(MinipoolSettings, [
    {
      ...
      value: function getLaunchBalance() {
        return this.rocketDAOProtocolSettingsMinipool.then(function (
          rocketDAOProtocolSettingsMinipool
        ) {
          return rocketDAOProtocolSettingsMinipool.methods
            .getLaunchBalance()
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getLaunchTimeout() {
        return this.rocketDAOProtocolSettingsMinipool
          .then(function (rocketDAOProtocolSettingsMinipool) {
            return rocketDAOProtocolSettingsMinipool.methods
              .getLaunchTimeout()
              .call();
          })
