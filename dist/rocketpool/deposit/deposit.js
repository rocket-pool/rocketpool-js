  ...
  _createClass(Deposit, [
    ...
    },
    {
      ...
      value: function getUserLastDepositBlock(address) {
        return this.rocketDepositPool.then(function (rocketDepositPool) {
          return rocketDepositPool.methods
            .getUserLastDepositBlock(address)
            .call();
        });
      },
      /**
    ...
    },
    {
      ...
      value: function deposit(options, onConfirmation) {
        return this.rocketDepositPool.then(function (rocketDepositPool) {
          return (0,
          _transaction.handleConfirmations)(rocketDepositPool.methods.deposit().send(options), onConfirmation);
        });
      },
      // Assign deposits
    },
    {
      ...
      value: function assignDeposits(options, onConfirmation) {
        return this.rocketDepositPool.then(function (rocketDepositPool) {
          return (0,
          _transaction.handleConfirmations)(rocketDepositPool.methods.assignDeposits().send(options), onConfirmation);
        });
      },
    },
    {
