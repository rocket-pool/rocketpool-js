  ...
  _createClass(Minipool, [
    ...
    },
    {
      ...
      value: function getNodeMinipools(nodeAddress) {
        ...
        return this.getNodeMinipoolAddresses(nodeAddress).then(function (
          addresses
        ) {
          return Promise.all(
            addresses.map(function (address) {
    ...
    },
    {
      ...
      value: function getMinipoolCount() {
        return this.rocketMinipoolManager
          .then(function (rocketMinipoolManager) {
    ...
    },
    {
      ...
      value: function getMinipoolAt(index) {
        return this.rocketMinipoolManager.then(function (
    ...
    },
    {
      ...
      value: function getNodeMinipoolCount(nodeAddress) {
        return this.rocketMinipoolManager
          .then(function (rocketMinipoolManager) {
            return rocketMinipoolManager.methods
    ...
    },
    {
      ...
      value: function getNodeMinipoolAt(nodeAddress, index) {
        return this.rocketMinipoolManager.then(function (
          ...
          return rocketMinipoolManager.methods
            .getNodeMinipoolAt(nodeAddress, index)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getQueueTotalLength() {
        return this.rocketMinipoolQueue
          .then(function (rocketMinipoolQueue) {
    ...
    },
    {
      ...
      value: function getMinipoolNodeRewardAmount(
        nodeFee,
        userDepositBalance,
        startBalance,
        endBalance
        ...
        return this.rocketMinipoolStatus.then(function (rocketMinipoolStatus) {
          return rocketMinipoolStatus.methods
            .getMinipoolNodeRewardAmount(
              _this5.web3.utils.toWei(nodeFee.toString(), "ether"),
              userDepositBalance,
              startBalance,
              endBalance
            )
    ...
    },
    {
      ...
      value: function getMinipoolContract(address) {
        ...
        return this.contracts
          .make("rocketMinipoolDelegate", address)
          .then(function (rocketMinipool) {
            return new _minipoolContract2.default(
              _this6.web3,
              address,
              rocketMinipool
            );
    ...
    },
    {
      ...
      value: function submitMinipoolWithdrawable(
        minipoolAddress,
        options,
        onConfirmation
      ) {
        return this.rocketMinipoolStatus.then(function (rocketMinipoolStatus) {
          return (0,
          _transaction.handleConfirmations)(rocketMinipoolStatus.methods.submitMinipoolWithdrawable(minipoolAddress).send(options), onConfirmation);
        });
      },
    },
    {
