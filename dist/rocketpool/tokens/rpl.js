...
var RPL = (function (_ERC) {
  ...
  function RPL(web3, contracts) {
    ...
    return _possibleConstructorReturn(
      this,
      (RPL.__proto__ || Object.getPrototypeOf(RPL)).call(
        this,
        web3,
        contracts,
        "rocketTokenRPL"
  ...
  _createClass(RPL, [
    ...
    },
    {
      ...
      value: function swapTokens(amountWei, options, onConfirmation) {
        return this.tokenContract.then(function (tokenContract) {
          return (0,
          _transaction.handleConfirmations)(tokenContract.methods.swapTokens(amountWei).send(options), onConfirmation);
        });
      },
    ...
    },
    {
      ...
      value: function inflationMintTokens(options, onConfirmation) {
        return this.tokenContract.then(function (tokenContract) {
          return (0,
          _transaction.handleConfirmations)(tokenContract.methods.inflationMintTokens().send(options), onConfirmation);
        });
      },
    },
  ]);
