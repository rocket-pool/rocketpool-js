  ...
  _createClass(Node, [
    ...
    },
    {
      ...
      value: function getNodeAddresses() {
        ...
        return this.getNodeCount().then(function (count) {
          return Promise.all(
            []
              .concat(_toConsumableArray(Array(count).keys()))
              .map(function (index) {
    ...
    },
    {
      ...
      value: function getNodeCount() {
        return this.rocketNodeManager
          .then(function (rocketNodeManager) {
    ...
    },
    {
      ...
      value: function getNodeTimezoneLocation(address) {
        return this.rocketNodeManager.then(function (rocketNodeManager) {
          return rocketNodeManager.methods
    ...
    },
    {
      ...
      value: function getNodeEffectiveRPLStake(address) {
        return this.rocketNodeStaking.then(function (rocketNodeStaking) {
          return rocketNodeStaking.methods
    ...
    },
    {
      ...
      value: function calculateTotalEffectiveRPLStake(offset, limit, rplPrice) {
        return this.rocketNodeStaking.then(function (rocketNodeStaking) {
          return rocketNodeStaking.methods
            .calculateTotalEffectiveRPLStake(offset, limit, rplPrice)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getNodeCountPerTimezone(offset, limit) {
        return this.rocketNodeManager.then(function (rocketNodeManager) {
          return rocketNodeManager.methods
            .getNodeCountPerTimezone(offset, limit)
            .call();
        });
      },
      /**
    ...
    },
    {
      ...
      value: function registerNode(timezoneLocation, options, onConfirmation) {
        return this.rocketNodeManager.then(function (rocketNodeManager) {
          return (0,
          _transaction.handleConfirmations)(rocketNodeManager.methods.registerNode(timezoneLocation).send(options), onConfirmation);
        });
      },
    },
    {
      key: "setWithdrawalAddress",
      value: function setWithdrawalAddress(
        nodeAddress,
        withdrawalAddress,
        confirm,
        options,
        ...
        return this.rocketStorage.then(function (rocketStorage) {
          return (0,
          _transaction.handleConfirmations)(rocketStorage.methods.setWithdrawalAddress(nodeAddress, withdrawalAddress, confirm).send(options), onConfirmation);
        });
      },
    },
    {
      ...
      value: function stakeRPL(amount, options, onConfirmation) {
        return this.rocketNodeStaking.then(function (rocketNodeStaking) {
          return (0,
          _transaction.handleConfirmations)(rocketNodeStaking.methods.stakeRPL(amount).send(options), onConfirmation);
        });
      },
    },
    {
      key: "confirmWithdrawalAddress",
      value: function confirmWithdrawalAddress(
        nodeAddress,
        options,
        onConfirmation
      ) {
        return this.rocketStorage.then(function (rocketStorage) {
          return (0,
          _transaction.handleConfirmations)(rocketStorage.methods.confirmWithdrawalAddress(nodeAddress).send(options), onConfirmation);
        });
      },
    },
    {
      ...
      value: function withdrawRPL(amount, options, onConfirmation) {
        return this.rocketNodeStaking.then(function (rocketNodeStaking) {
          return (0,
          _transaction.handleConfirmations)(rocketNodeStaking.methods.withdrawRPL(amount).send(options), onConfirmation);
        });
      },
      /**
    ...
    },
    {
      ...
      value: function setTimezoneLocation(
        timezoneLocation,
        options,
        onConfirmation
      ) {
        return this.rocketNodeManager.then(function (rocketNodeManager) {
          return (0,
          _transaction.handleConfirmations)(rocketNodeManager.methods.setTimezoneLocation(timezoneLocation).send(options), onConfirmation);
        });
      },
      // Make a node deposit
    },
    {
      ...
      value: function deposit(minimumNodeFee, options, onConfirmation) {
        return this.rocketNodeDeposit.then(function (rocketNodeDeposit) {
          return (0,
          _transaction.handleConfirmations)(rocketNodeDeposit.methods.deposit(minimumNodeFee).send(options), onConfirmation);
        });
      },
    },
    {
