  ...
  _createClass(DAONodeTrustedActions, [
    {
      ...
      value: function actionJoin(options, onConfirmation) {
        return this.rocketDAONodeTrustedActions.then(function (
    ...
    },
    {
      ...
      value: function actionLeave(refundAddress, options, onConfirmation) {
        return this.rocketDAONodeTrustedActions.then(function (
          ...
          return (0, _transaction.handleConfirmations)(
            rocketDAONodeTrustedActions.methods
              .actionLeave(refundAddress)
              .send(options),
            onConfirmation
          );
        });
