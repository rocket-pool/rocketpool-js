  ...
  _createClass(DAONodeTrusted, [
    ...
    },
    {
      ...
      value: function getProposalQuorumVotesRequired() {
        return this.rocketDAONodeTrusted.then(function (rocketDAONodeTrusted) {
          return rocketDAONodeTrusted.methods
    ...
    },
    {
      ...
      value: function getMemberRPLBondAmount(address) {
        return this.rocketDAONodeTrusted.then(function (rocketDAONodeTrusted) {
          return rocketDAONodeTrusted.methods
            .getMemberRPLBondAmount(address)
            .call();
        });
      },
    ...
    {
      key: "bootstrapMember",
      value: function bootstrapMember(
        id,
        url,
        nodeAddress,
        options,
        ...
        return this.rocketDAONodeTrusted.then(function (rocketDAONodeTrusted) {
          return (0,
          _transaction.handleConfirmations)(rocketDAONodeTrusted.methods.bootstrapMember(id, url, nodeAddress).send(options), onConfirmation);
        });
      },
    ...
    },
    {
      ...
      value: function bootstrapSettingBool(
        settingContractInstance,
        settingPath,
        value,
        options,
        onConfirmation
        ...
        return this.rocketDAONodeTrusted.then(function (rocketDAONodeTrusted) {
          return (0,
          _transaction.handleConfirmations)(rocketDAONodeTrusted.methods.bootstrapSettingBool(settingContractInstance, settingPath, value).send(options), onConfirmation);
        });
      },
      // Bootstrap disable
    },
    {
      ...
      value: function bootstrapDisable(value, options, onConfirmation) {
        return this.rocketDAONodeTrusted.then(function (rocketDAONodeTrusted) {
          return (0,
          _transaction.handleConfirmations)(rocketDAONodeTrusted.methods.bootstrapDisable(value).send(options), onConfirmation);
        });
      },
      // Bootstrap disable
    },
    {
      ...
      value: function memberJoinRequired(id, url, options, onConfirmation) {
        return this.rocketDAONodeTrusted.then(function (rocketDAONodeTrusted) {
          return (0,
          _transaction.handleConfirmations)(rocketDAONodeTrusted.methods.memberJoinRequired(id, url).send(options), onConfirmation);
        });
      },
    },
    {
