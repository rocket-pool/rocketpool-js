  ...
  _createClass(Network, [
    {
      ...
      value: function getBalancesBlock() {
        return this.rocketNetworkBalances
          .then(function (rocketNetworkBalances) {
    ...
    },
    {
      ...
      value: function getTotalETHBalance() {
        return this.rocketNetworkBalances.then(function (
    ...
    },
    {
      ...
      value: function getEffectiveRPLStakeUpdatedBlock() {
        return this.rocketNetworkPrices.then(function (rocketNetworkPrices) {
          return rocketNetworkPrices.methods
    ...
    },
    {
      ...
      value: function submitBalances(
        ...
        return this.rocketNetworkBalances.then(function (
          ...
          return (0, _transaction.handleConfirmations)(
            rocketNetworkBalances.methods
              .submitBalances(block, totalEth, stakingEth, rethSupply)
              .send(options),
            onConfirmation
          );
        });
    ...
    },
    {
      ...
      value: function submitPrices(
        ...
        return this.rocketNetworkPrices.then(function (rocketNetworkPrices) {
          return (0,
          _transaction.handleConfirmations)(rocketNetworkPrices.methods.submitPrices(block, rplPrice, effectiveRplStake).send(options), onConfirmation);
        });
      },
    ...
    },
    {
      ...
      value: function executeUpdatePrices(
        block,
        rplPrice,
        effectiveRplStake,
        options,
        ...
        return this.rocketNetworkPrices.then(function (rocketNetworkPrices) {
          return (0,
          _transaction.handleConfirmations)(rocketNetworkPrices.methods.executeUpdatePrices(block, rplPrice, effectiveRplStake).send(options), onConfirmation);
        });
      },
    ...
    },
    {
      ...
      value: function executeUpdateBalances(
        block,
        totalEth,
        stakingEth,
        rethSupply,
        ...
        return this.rocketNetworkBalances.then(function (
          ...
          return (0, _transaction.handleConfirmations)(
            rocketNetworkBalances.methods
              .executeUpdateBalances(block, totalEth, stakingEth, rethSupply)
              .send(options),
            onConfirmation
          );
        });
