  ...
  _createClass(Pool, [
    ...
    },
    {
      ...
      value: function getClaimingContractPerc(contract) {
        return this.rocketRewardsPool.then(function (rocketRewardsPool) {
          return rocketRewardsPool.methods
            .getClaimingContractPerc(contract)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getClaimingContractAllowance(contract) {
        return this.rocketRewardsPool.then(function (rocketRewardsPool) {
          return rocketRewardsPool.methods
            .getClaimingContractAllowance(contract)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getClaimingContractTotalClaimed(contract) {
        return this.rocketRewardsPool.then(function (rocketRewardsPool) {
          return rocketRewardsPool.methods
            .getClaimingContractTotalClaimed(contract)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getClaimContractRegisteredTime(
        contractAddress,
        trustedNodeAddress
      ) {
        return this.rocketRewardsPool.then(function (rocketRewardsPool) {
          return rocketRewardsPool.methods
            .getClaimContractRegisteredTime(contractAddress, trustedNodeAddress)
            .call();
        });
      },
    ...
    },
    {
      ...
      value: function getClaimingContractUserTotalCurrent(address) {
        return this.rocketRewardsPool.then(function (rocketRewardsPool) {
          return rocketRewardsPool.methods
            .getClaimingContractUserTotalCurrent(address)
            .call();
        });
      },
    },
