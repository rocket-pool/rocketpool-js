...
function getMinipoolMinimumRPLStake(web3, rp) {
  return __awaiter(
    ...
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee4() {
      var rocketDAOProtocolSettingsMinipool,
            ...
            switch ((_context4.prev = _context4.next)) {
              ...
              case 8:
                ...
                return _context4.abrupt(
                  "return",
                  depositUserAmount.mul(minMinipoolStake).div(rplPrice)
                );
          ...
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              ...
              case 5:
                ...
                minipoolCreatedEvents = (0, _contract.getTxContractEvents)(
                  web3,
                  txReceipt,
              ...
              case 9:
                return _context5.abrupt(
                  "return",
                  rp.minipool.getMinipoolContract(
                    minipoolCreatedEvents[0].minipool
                  )
                );
          ...
          while (1) {
            switch ((_context6.prev = _context6.next)) {
              case 0:
                ...
                if (!validatorPubkey)
                  validatorPubkey = (0, _beacon.getValidatorPubkey)();
              ...
              case 3:
                ...
                depositData = {
                  ...
                  withdrawalCredentials: Buffer.from(
                    withdrawalCredentials.substr(2),
                    "hex"
                  ),
        ...
        function _callee7$(_context7) {
          while (1) {
            switch ((_context7.prev = _context7.next)) {
              case 0:
                _context7.next = 2;
                return rp.minipool.submitMinipoolWithdrawable(
                  minipoolAddress,
                  options
                );
